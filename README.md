...
- `03_Block_Structure`: Linking blocks, Immutability.
- `04_Accounting_Models`: UTXO vs. Account models, Double-spend protection.
- `05_Tree_Data_Structures`: Binary trees, search algorithms.
- `06_Merkle_Trees`: Merkle proofs, data integrity.
- `07_Ethereum_Architecture`: EVM, gas, accounts.
